...
<head>
	<%
		Login l = new Login();
		if (request.getSession().getAttribute("skor") != null) {
 		 	l = (Login)request.getSession().getAttribute("skor");
		}
	%>
...
<body> 
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item dropdown">
					 ...
					 <li class="nav-item">
					 	<a class="nav-link" href="#profile"><%= login.getFirstName().toUpperCase() %></a>
					</li>
					<li class="nav-item">
	...
	<section class="info-section">
		<div class="container">
			<div class="head-box text-center mb-5" style="margin-top:50px;">
				<h2 class="text-underline-primary">High Score Table</h2>
			</div>
			<div class="three-panel-block mt-6">
				<div class="row">
					<div class="col-lg-4">
						
					</div>
						<div class="service-block-overlay text-center col-lg-4">
							
			
							
							<ul class="list-group list-group-horizontal-xl">
							  <li class="list-group-item list-group-item-secondary"><%=l.getFirstName() %></li>
							  <li class="list-group-item list-group-item-success"><%=l.getLastName() %></li>
							  <li class="list-group-item list-group-item-primary"><%=l.getScore() %></li>
							</ul>
							<ul class="list-group list-group-horizontal-xl">
							  <li class="list-group-item list-group-item-secondary">YASIN</li>
							  <li class="list-group-item list-group-item-success">DEMIRKAYA</li>
							  <li class="list-group-item list-group-item-primary">4</li>
							</ul>
							<ul class="list-group list-group-horizontal-xl">
							  <li class="list-group-item list-group-item-secondary">OMER</li>
							  <li class="list-group-item list-group-item-success">KAVAK</li>
							  <li class="list-group-item list-group-item-primary">3</li>
							</ul>
							<ul class="list-group list-group-horizontal-xl">
							  <li class="list-group-item list-group-item-secondary">OMER</li>
							  <li class="list-group-item list-group-item-success">SAHINLER</li>
							  <li class="list-group-item list-group-item-primary">2</li>
							</ul>
							<ul class="list-group list-group-horizontal-xl">
							  <li class="list-group-item list-group-item-secondary">EMRE</li>
							  <li class="list-group-item list-group-item-success">DEMIR</li>

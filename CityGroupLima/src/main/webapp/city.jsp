...
<!DOCTYPE html>
	<%
		...
		if (request.getAttribute("city") != null) {
 		 	c = (City)request.getAttribute("city");
		}
...
<body>
	<nav class="navbar navbar-expand-md fixed-top top-nav">
		<div class="container">
			<a class="navbar-brand" href="homepage.jsp"><strong><img src="http://www.sclance.com/pngs/world-map-black-and-white-png/world_map_black_and_white_png_1537152.png" style="width:40px; height:40px;"/><%= c.getCityName()%></strong></a>
					...
					<li class="nav-item dropdown">
            			...
            			<div class="dropdown-menu" aria-labelledby="dropdown01">
		             		 <a class="dropdown-item" href="memorygame.jsp">Memory Game</a>
		              		 <!-- <a class="dropdown-item" href='PuzzleControl?CityName=<%= c.getCityName()%>'>Puzzle Game</a> -->
		              		 <a class="dropdown-item" href='QuestionController?CityName=<%=c.getCityName()%>'>Quiz</a>
            			</div>
         			 </li>
					<li class="nav-item">
	...
	<section class="intro carousel slide bg-overlay-light h-auto" id="carouselExampleCaptions">
		...
		<div class="carousel-inner" role="listbox">
			<div class="carousel-item active">
				<img style="width:100%;" class="d-block img-fluid" alt="First slide" src=<%= c.getCarusel1Back() %>>
				<div class="carousel-caption ">
					<h2 class="display-4 text-white mb-2 mt-4"><%= c.getCarusel1() %></h2>
					<p class="text-white mb-3 px-5 lead"><%= c.getCarusel1Alt() %> </p>	
				</div>
			</div>
			<div class="carousel-item">
				<img style="width:100%" class="d-block img-fluid" alt="First slide" src=<%= c.getCarusel2Back() %>>
				<div class="carousel-caption ">
					<h2 class="display-4 text-white mb-2 mt-4"><%= c.getCarusel2() %></h2>
					<p class="text-white mb-3 px-5 lead"><%= c.getCarusel2Alt() %></p>
					<a href="worldmap.jsp" class="btn btn-primary btn-capsul px-4 py-2">Go to the World Map</a>
				</div>
			</div>
			<div class="carousel-item">
				<img style="width:100%" class="d-block img-fluid" alt="First slide" src="<%= c.getCarusel3Back() %>">
				<div class="carousel-caption ">
					<h2 class="display-4 text-white mb-2 mt-4"><%= c.getCarusel3() %></h2>
					<p class="text-white mb-3 px-5 lead"><%= c.getCarusel3Alt() %></p>
					<a href="worldmap.jsp" class="btn btn-primary btn-capsul px-4 py-2">Go to the World Map</a>
				</div>
			</div>
		</div>
	...
	<section class="info-section">
		<div class="container">
			<div class="three-panel-block mt-1">
				<div class="row">
					<div class="col-lg-12">
					...
					<div class="col-lg-12 col-md-12 col-sm-12">
						<div class="service-block-overlay text-center mb-5 p-lg-3">
							<h3><strong><%= c.getCityName() %></strong></h3>
							<p class="px-4">
							<%= c.getInfo() %>
							</p>
						</div>
					...
					<div class="col-lg-5 col-md-12 col-sm-12">
						<div class="service-block-overlay text-center mb-5 p-lg-3">
							<img src="<%= c.getInfo1Right() %>" style="width:400px; height:400px;"/>	
						</div>
					</div>
					<div class="col-lg-12">
						<hr class="featurette-divider">
					...
					<div class="col-lg-5 col-md-12 col-sm-12">
						<div class="service-block-overlay text-center mb-5 p-lg-3">
							<img src="<%= c.getInfo2Left() %>" style="width:400px; height:400px;"/>	
						</div>
					</div>
				  	<div class="col-lg-7 col-md-12 col-sm-12">
						<div class="service-block-overlay text-center mb-5 p-lg-3">
           ...
           <div class="row mx-auto">
            <div class="demo-gallery ">
                <ul id="lightgallery" class="list-unstyled row">
                    <li class="col-lg-3" data-responsive="<%= c.getImg1() %>" data-src="<%= c.getImg1() %>">
                        <a href="">
                            <img class="img-responsive" src="<%= c.getImg1() %>">
                        </a>
                    </li>
                    <li class="col-lg-3" data-responsive="<%= c.getImg2() %>" data-src="<%= c.getImg2() %>">
                        <a href="">
                            <img class="img-responsive" src="<%= c.getImg2() %>">
                        </a>
                    </li>
                    <li class="col-lg-3" data-responsive="<%= c.getImg3() %>" data-src="<%= c.getImg3() %>">
                        <a href="">
                            <img class="img-responsive" src="<%= c.getImg3() %>">
                        </a>
                    </li>
                    <li class="col-lg-3" data-responsive="<%= c.getImg4() %>" data-src="<%= c.getImg4() %>">
                        <a href="">
                            <img class="img-responsive" src="<%= c.getImg4() %>">
                        </a>
                    </li>
                    <li class="col-lg-3" data-responsive="<%= c.getImg5() %>" data-src="<%= c.getImg5() %>">
                        <a href="">
                            <img class="img-responsive" src="<%= c.getImg5() %>">
                        </a>
                    </li>
                    <li class="col-lg-3" data-responsive="<%= c.getImg6() %>" data-src="<%= c.getImg6() %>">
                        <a href="">
                            <img class="img-responsive" src="<%= c.getImg6() %>">
                        </a>
                    </li>
                    <li class="col-lg-3" data-responsive="<%= c.getImg7() %>" data-src="<%= c.getImg7() %>">
                        <a href="">
                            <img class="img-responsive" src="<%= c.getImg7() %>">
                        </a>
                    </li>
                    <li class="col-lg-3" data-responsive="<%= c.getImg8() %>" data-src="<%= c.getImg8() %>">
                        <a href="">
                            <img class="img-responsive" src="<%= c.getImg8() %>">
                        </a>
